...
<head>
    ...
    <style>
        ...
        .sidebar-link { display:flex; align-items:center; padding-top:5px; gap:12px; border-radius:8px; font-weight:500; color:#64748B; transition:0.25s; }
...
<aside class="w-52 bg-white shadow-md p-5 flex flex-col gap-3 rounded-2xl sticky top-4 h-[calc(100vh-2rem)] ml-4">
    ...
    <div class="w-full mb-2">
        ...
        <div id="settingsMenu" class="hidden mt-1 rounded-lg">
            ...
            <a href="users.php" class="sidebar-link <?= $activePage=="users"?"sidebar-active":"" ?>"><span class="material-icons">people_alt</span> Users</a>
        </div>
    </div>
    <?php endif; ?>
</aside>
...
<script>
document.getElementById("productsToggleBtn").onclick = () => { document.getElementById("productsMenu").classList.toggle("hidden"); }
document.getElementById("userToggleBtn").onclick = () => { document.getElementById("userMenu").classList.toggle("hidden"); }
document.getElementById("settingsToggleBtn")?.addEventListener("click", () => { document.getElementById("settingsMenu").classList.toggle("hidden"); });
</script>
...
<script>
document.getElementById("openTaxModal")?.addEventListener("click", () => { document.getElementById("taxModal").classList.remove("hidden"); });
document.getElementById("closeTaxModal")?.addEventListener("click", () => { document.getElementById("taxModal").classList.add("hidden"); });
</script>
