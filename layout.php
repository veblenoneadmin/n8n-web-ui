...
<!-- SIDEBAR -->
<aside class="w-52 bg-white shadow-md p-5 flex flex-col gap-3 rounded-2xl
              sticky top-4 h-[calc(100vh-2rem)] ml-4">
...
<div class="w-full mb-2">
    <button id="userToggleBtn"
            class="w-full flex items-center justify-between  py-2 rounded-lg hover:bg-gray-100 transition">
    ...
    <a href="settings.php" class="flex items-center gap-3 px-1.5 py-2 text-gray-700 rounded hover:bg-gray-100">
        <span class="material-icons text-gray-500 text-base">settings</span>
        Settings
    </a>
...
<div class="border-b border-gray-200 mt-1"></div>
    ...
    <!-- NAV ITEMS -->
    <a href="home.php" class="sidebar-link <?= $activePage=="home"?"sidebar-active":"" ?>"><span class="material-icons">dashboard</span> Home</a>
    ...
    <a href="products.php" class="sidebar-link <?= $activePage=="products"?"sidebar-active":"" ?>"><span class="material-icons">inventory_2</span> Products</a>
    <?php if (!empty($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
        <a href="users.php" class="sidebar-link <?= $activePage=="personnel"?"sidebar-active":"" ?>"><span class="material-icons">people_alt</span> Users</a>
    <?php endif; ?>
        ...
        <div class="flex items-center gap-4">
            <div class="relative">
                <input type="text" placeholder="Search here"
                       class="border rounded-lg px-4 py-2 pl-10 w-48 md:w-64 bg-white shadow-sm focus:outline-none focus:border-indigo-500">
